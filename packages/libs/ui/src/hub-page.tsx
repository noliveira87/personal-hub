			...
			<section className="mx-auto flex min-h-screen max-w-4xl flex-col items-center justify-center px-4 py-6 sm:px-6 sm:py-8">
				<div className="w-full">
					...
					<div className="mb-3 flex justify-center sm:mb-4">
						<div className="relative flex w-full max-w-[430px] items-center justify-center px-2 py-2 sm:max-w-[560px] sm:px-4 sm:py-3">
							...
							<img
								...
								className="relative z-10 h-auto max-h-[17rem] w-auto max-w-full object-contain drop-shadow-[0_18px_30px_hsl(var(--foreground)/0.14)] sm:max-h-[22rem]"
							/>
						</div>
					</div>
