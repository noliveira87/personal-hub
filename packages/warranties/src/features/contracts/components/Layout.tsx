...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Fixed header - desktop and mobile */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-lg border-b border-border">
        <div className="flex items-center justify-between h-16 px-4 lg:px-6 max-w-full">
          ...
          <h1 className="text-lg font-semibold text-foreground tracking-tight absolute left-1/2 transform -translate-x-1/2 hidden sm:block">D12 Contracts</h1>
