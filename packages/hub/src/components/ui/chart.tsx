  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-border/70 bg-card px-2.5 py-1.5 text-xs text-foreground shadow-xl",
          className,
        )}
      >
                ...
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    ...
                    >
                      <div className="grid gap-1.5">
                        {nestLabel ? tooltipLabel : null}
                        <span className="text-foreground/80">{itemConfig?.label || item.name}</span>
                      </div>
                      {item.value && (
    ...
    >
      {payload.map((item) => {
        ...
        return (
          <div
            key={item.value}
            className={cn("flex items-center gap-1.5 text-foreground [&>svg]:h-3 [&>svg]:w-3 [&>svg]:text-foreground/80")}
          >
