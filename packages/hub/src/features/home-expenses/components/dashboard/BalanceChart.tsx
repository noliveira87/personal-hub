...
export default function BalanceChart() {
  ...
  return (
    <div className="h-full rounded-3xl border border-border/80 bg-card p-5 shadow-sm sm:p-6 flex flex-col">
      ...
      <div ref={chartRef} className="flex-1 min-h-[16rem] w-full">
        {width > 0 && (
          <BarChart width={width} height={256} data={chartData} barGap={6} barCategoryGap="16%" margin={{ top: 6, right: 8, left: -8, bottom: 0 }}>
